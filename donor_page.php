                ...
                <div class="col-sm-4">
                    <div class="card" > 
                        <div class="card-body"> 
                                <div>
                                 <?php
        $sqldonation="SELECT COUNT(donor_id) as donor_count FROM donation LEFT JOIN blood_details ON blood_details.blood_details_id = donation.blood_details_id WHERE donor_id= $id";
...
$result = $connection->query($sql);
                ...
                <div class="col-md-auto col-sm-6"> 
                    <div class="card">
                    <form action="hospital_appointment/editAppointment.php?appointment_id=<?php echo $appointment_id;?>" method="post" style='margin-top:10px;'>
                        ...
                        <div class="card-body"> 
                                ...
                                <h5 class="header-title mt-0 mb-4"><strong>Time: </strong><?php echo date('h:i a',strtotime($row['time'])); ?></h5>
                                </div>
                 ...
                 <?php
                    ...
                    blood_drive ON blood_drive.blood_drive_id = drive_booking.blood_drive_id WHERE `date_to` >= $current_date AND donor_id = '$id' AND `status`='pending' ";
                ...
                <div class="col-md-auto col-sm-6"> 
                    ...
                    <form action="connection/deleteDriveBooking.php?drive_booking_id=<?php echo $drive_booking_id;?>" method="post" style='margin-top:10px;'>
                        ...
                        echo "<div class = 'col'></div><div style = 'text-align:center; margin-top: 20px;'class = 'col-md-auto'><h5>You are not registered to any upcoming blood drives</h5></div><div class = 'col'></div>";
                    }
                ?>
                 </div>
                        </div>
